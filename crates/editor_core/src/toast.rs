...
mod tests {
    ...
    fn toast_plugin_received_event() {
        ...
        assert!(!app
            ...
            .has_toasts());
        app.world_mut()
            .write_event(ToastMessage::new("Test message", ToastKind::Error));
        app.world_mut()
            .write_event(ToastMessage::new("Test message", ToastKind::Error));
        app.world_mut()
            .write_event(ToastMessage::new("Test message", ToastKind::Error));
        app.update();
        app.world_mut()
            .write_event(ToastMessage::new("Test message", ToastKind::Warning));
        app.world_mut()
            .write_event(ToastMessage::new("Test message", ToastKind::Warning));
        app.world_mut()
            .write_event(ToastMessage::new("Test message", ToastKind::Warning));
    ...
    fn clear_toasts() {
        ...
        app.world_mut().write_event(ClearToastMessage::error(1));
        app.world_mut().write_event(ClearToastMessage::warn(1));
        app.update();
    ...
    fn clear_all_toasts() {
        ...
        app.world_mut().write_event(ClearToastMessage::all());
        app.update();
    ...
    fn empty_storage_for_info_toasts() {
        ...
        assert!(!app
            ...
            .has_toasts());
        app.world_mut()
            .write_event(ToastMessage::new("Test message", ToastKind::Info));
        app.update();
